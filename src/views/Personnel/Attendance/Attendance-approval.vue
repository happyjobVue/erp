            ...
            <div class="content">
              ...
              <p class="conTitle">
                ...
                <span class="searchBox">
                  ...
                  <a class="btnType red" href="#" @click.prevent="searchList"><span>검색</span></a>
                </span>
              </p>
              ...
              <table class="tbl">
                ...
                <tbody>
                  <tr v-for="(item, idx) in AttendanceList.attendanceList" :key="AttendanceList.id">
                    <td>{{ item.id }}</td>
                    <td>{{ item.reqType }}</td>
                    <td>{{ item.number }}</td>
                    <td>{{ item.name }}</td>
              ...
              <div class="paging_area" style="display: flex; justify-content: center;">
              <Pagination
